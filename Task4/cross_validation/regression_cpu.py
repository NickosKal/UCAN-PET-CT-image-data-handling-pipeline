...
def main():
    ...
    df = pd.read_excel("c:\\Users\\adha3755\\Documents\\UCAN_Regression\\dataset_for_model_regression_training.xlsx")
    df = df[['patient_ID','scan_date','SUV_MIP','CT_MIP', 'patient_age']]
    df = df.replace('/media/andres/T7 Shield1/UCAN_project/collages/reshaped_collages', r'C:\\Users\\adha3755\\Documents\\UCAN_Regression\\reshaped_collages', regex=True)
    ...
    path_output = "C:\\Users\\adha3755\\Documents\\UCAN_Regression\\Results\\"
